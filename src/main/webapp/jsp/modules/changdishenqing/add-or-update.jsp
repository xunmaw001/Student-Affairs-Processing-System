    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑场地申请</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑场地申请</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">场地申请信息</h3>
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 aaaaaaa">
                                        ...
                                        <input id="banjiValue" name="banjiValue" class="form-control"
                                               placeholder="学生班级" readonly>
                                    </div>
                                    <div class="form-group col-md-6 aaaaaaa">
                                        <label>学生年级</label>
                                        <input id="nianjiValue" name="nianjiValue" class="form-control"
                                               placeholder="学生年级" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
                                    <input id="updateId" name="id" type="hidden">
                                   <div class="form-group col-md-6">
                                       <label>场地</label>
                                       <select id="changdiTypesSelect" name="changdiTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>使用类型</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           // }
            ...
            httpJson("changdishenqing/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addchangdishenqing');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                changdiTypes: "场地不能为空",
                shiyongTypes: "使用类型不能为空",
                yonghuId: "申请人不能为空",
                startTime: "使用时间不能为空",
                endTime: "结束时间不能为空",
                shenqingContent: "申请内容不能为空",
                shenheTypes: "审核类型不能为空",
    ...
    // 获取当前详情
    function getDetails() {
        var addchangdishenqing = window.sessionStorage.getItem("addchangdishenqing");
        if (addchangdishenqing != null && addchangdishenqing != "" && addchangdishenqing != "null") {
            window.sessionStorage.removeItem('addchangdishenqing');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("changdishenqing/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '用户') {
            ...
            $('#changdiTypesSelect').attr('style', 'pointer-events: none;');
            $('#changdiTypesSelect').attr('readonly', 'readonly');
            $('#shiyongTypesSelect').attr('style', 'pointer-events: none;');
            $('#shiyongTypesSelect').attr('readonly', 'readonly');
            $('#startTime-input').attr('style', 'pointer-events: none;');
            $('#startTime-input').attr('readonly', 'readonly');
            $('#endTime-input').attr('style', 'pointer-events: none;');
            $('#endTime-input').attr('readonly', 'readonly');
            var shenqingContentEditor = UE.getEditor('shenqingContentEditor');
            shenqingContentEditor.ready(function () {
                shenqingContentEditor.setDisabled('fullscreen');
            });
        }
    }
