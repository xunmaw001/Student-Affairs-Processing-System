    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">场地申请管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">场地申请管理</li>
                        <li class="breadcrumb-item active">场地申请列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">场地申请列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                 
                                            <label>
                                                场地
                                                <select name="changdiTypesSelectSearch" style="width: 100px;" id="changdiTypesSelectSearch" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                使用类型
                                                <select name="shiyongTypesSelectSearch" style="width: 100px;" id="shiyongTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                                            ...
                                            <label>
                                                审核类型
                                                <select name="shenheTypesSelectSearch" style="width: 100px;" id="shenheTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                                            ...
                                            <label>
                                                学生年级
                                                <select name="nianjiTypesSelectSearch"  style="width: 150px;" id="nianjiTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
...
<script>
    ...
    function search() {
        ...
        var nianjiTypesSelectSearchInput = document.getElementById("nianjiTypesSelectSearch");
        if(nianjiTypesSelectSearchInput != null){
            var nianjiTypesIndex = nianjiTypesSelectSearchInput.selectedIndex;
            if( nianjiTypesIndex  != 0){
                searchForm.nianjiTypes = document.getElementById("nianjiTypesSelectSearch").options[nianjiTypesIndex].value;
            }
        }
    <!-- 本表的查询条件 -->
        ...
        if(changdiTypesSelectSearchInput != null){
            ...
            //使用类型
        var shiyongTypesSelectSearchInput = document.getElementById("shiyongTypesSelectSearch");
        if(shiyongTypesSelectSearchInput != null){
            var shiyongTypesIndex = shiyongTypesSelectSearchInput.selectedIndex;
            if( shiyongTypesIndex  != 0){
                searchForm.shiyongTypes= document.getElementById("shiyongTypesSelectSearch").options[shiyongTypesIndex].value;
            }
        }
    ...
    function getDataList() {
        http("changdishenqing/page", "GET", {
            ...
            shiyongTypes: searchForm.shiyongTypes,
            ...
            //级联表的
                        ...
                        nianjiTypes: searchForm.nianjiTypes,
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("changdishenqing/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addchangdishenqing", "addchangdishenqing");
        window.location.href = "add-or-update.jsp"
    }
    ...
    //填充级联表搜索下拉框
        ...
        function nianjiTypesSelectSearch() {
            var nianjiTypesSelectSearch = document.getElementById('nianjiTypesSelectSearch');
            if(nianjiTypesSelectSearch != null) {
                nianjiTypesSelectSearch.add(new Option('-请选择-',''));
                if (nianjiTypesOptions != null && nianjiTypesOptions.length > 0){
                    for (var i = 0; i < nianjiTypesOptions.length; i++) {
                            nianjiTypesSelectSearch.add(new Option(nianjiTypesOptions[i].indexName, nianjiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //填充本表搜索下拉框
        ...
        function shiyongTypesSelectSearch() {
            var shiyongTypesSelectSearch = document.getElementById('shiyongTypesSelectSearch');
            if(shiyongTypesSelectSearch != null) {
                shiyongTypesSelectSearch.add(new Option('-请选择-',''));
                if (shiyongTypesOptions != null && shiyongTypesOptions.length > 0){
                    for (var i = 0; i < shiyongTypesOptions.length; i++) {
                            shiyongTypesSelectSearch.add(new Option(shiyongTypesOptions[i].indexName,shiyongTypesOptions[i].codeIndex));
                    }
                }
            }
        }
