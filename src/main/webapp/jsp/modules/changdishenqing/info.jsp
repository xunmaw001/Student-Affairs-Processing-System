            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">场地申请登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>场地</label>
                                    <input id="changdiValue" name="changdiValue" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <label>使用类型</label>
                                    <input id="shiyongValue" name="shiyongValue" class="form-control"
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "changdishenqing/info/" + id,
