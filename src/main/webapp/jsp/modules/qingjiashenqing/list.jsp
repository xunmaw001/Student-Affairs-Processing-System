            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">请假申请管理</li>
                        <li class="breadcrumb-item active">请假申请列表</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                请假类型
                                                <select name="qingjiaTypesSelectSearch" style="width: 100px;" id="qingjiaTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addqingjiashenqing", "addqingjiashenqing");
        window.location.href = "add-or-update.jsp"
    }
